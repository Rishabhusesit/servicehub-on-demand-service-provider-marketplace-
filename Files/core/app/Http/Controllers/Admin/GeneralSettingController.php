...
class GeneralSettingController extends Controller {
    ...
    public function generalUpdate(Request $request) {
        ...
        $general->commission_fixed_charge      = $request->commission_fixed_charge;
        $general->commission_percentage_charge = $request->commission_percentage_charge;
        $general->pusher_app_id                = $request->pusher_app_id;
        $general->pusher_app_key               = $request->pusher_app_key;
        $general->pusher_app_secret            = $request->pusher_app_secret;
        $general->pusher_app_cluster           = $request->pusher_app_cluster;
    ...
    public function systemConfigurationSubmit(Request $request) {
        ...
        $general->provider_registration = $request->provider_registration ? Status::ENABLE : Status::DISABLE;
    ...
    public function maintenanceModeSubmit(Request $request) {
        ...
        $maintenance = Frontend::where('data_keys', 'maintenance.data')->firstOrFail();
        $image       = isset($maintenance->data_values->image) ? $maintenance->data_values->image : null;
    ...
    public function updateOrderStep(Request $request) {
        $steps = [];
        ...
        $general              = gs();
        $general->order_steps = $steps;
        $general->save();

        $notify[] = ['success', 'Order step updated successfully'];
        return back()->withNotify($notify);
    }
}
