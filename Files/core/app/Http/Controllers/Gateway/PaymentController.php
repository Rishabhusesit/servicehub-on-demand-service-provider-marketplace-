...
class PaymentController extends Controller {
    ...
    public function depositInsert(Request $request, $order_id) {
        ...
        $order = Order::where('user_id', $user->id)->where('id', $order_id)->where('payment_status', Status::UNPAID)->first();
        ...
        $data->btc_wallet      = "";
        $data->trx             = $order->trx;
        $data->success_url     = route('user.order.details', $order->id);
        $data->failed_url      = route('user.order.details', $order->id);
        $data->save();
    ...
    public static function userDataUpdate($deposit, $isManual = null) {
        ...
        if ($deposit->status == Status::PAYMENT_INITIATE || $deposit->status == Status::PAYMENT_PENDING) {
            ...
            if ($deposit->order_id) {
                ...
                $order                 = Order::where('id', $deposit->order_id)->firstOrFail();
