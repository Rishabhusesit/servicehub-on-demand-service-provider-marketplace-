                    ...
                    <form method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-sm-6">
                                <div class="form-group ">
                                    <label> @lang('Commission Fixed Charge')</label>
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="commission_fixed_charge" value="{{ getAmount(gs('commission_fixed_charge')) }}">
                            ...
                            <div class="col-xl-6 col-sm-6">
                                <div class="form-group ">
                                    <label> @lang('Commission Percentage Charge')</label>
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="commission_percentage_charge" value="{{ getAmount(gs('commission_percentage_charge')) }}">
                                        <span class="input-group-text">
                                            %
                                        </span>
                                    </div>
                        ...
                        <h6 class="mb-3">@lang('Pusher Setting')</h6>
                        <div class="row">
                            <div class="col-xl-6 col-sm-6">
                                <div class="form-group ">
                                    <label> @lang('Pusher App ID')</label>
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="pusher_app_id" value="{{ gs('pusher_app_id') }}">
                            ...
                            <div class="col-xl-6 col-sm-6">
                                <div class="form-group ">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="pusher_app_key" value="{{ gs('pusher_app_key') }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-6 col-sm-6">
                                <div class="form-group ">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="pusher_app_secret" value="{{ gs('pusher_app_secret') }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-6 col-sm-6">
                                <div class="form-group ">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="pusher_app_cluster" value="{{ gs('pusher_app_cluster') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
