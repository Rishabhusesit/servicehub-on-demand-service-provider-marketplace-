            ...
            <div class="modal-content">
                ...
                <form method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>@lang('Provider Callback URL')</label>
                            <div class="input-group">
                                <input type="text" class="form-control provider-callback" readonly>
                                <button type="button" class="input-group-text copyInput" title="@lang('Copy')">
                                    <i class="las la-clipboard"></i>
                                </button>
                            </div>
    ...
    <script>
        (function($) {
            ...
            $(document).on('click', '.editBtn', function() {
                ...
                let providerCallbackUrl = "{{ route('provider.social.login.callback', '') }}";
                ...
                modal.find('.provider-callback').val(`${providerCallbackUrl}/${data.key}`);
                modal.modal('show');
            });
