                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($log->user_id != 0)
                                                ...
                                                <br>
                                                <span class="small"> <a href="{{ route('admin.users.detail', $log->user_id) }}"><span>@</span>{{ $log?->user?->username }}</a>
                                                </span>
                                            @else
                                                <span class="fw-bold">{{ $log?->provider?->fullname }}</span>
                                                <br>
                                                <span class="small"> <a href="{{ route('admin.providers.detail', $log->provider_id) }}"><span>@</span>{{ $log?->provider?->username }}</a>
                                                </span>
                                            @endif
                                        </td>
