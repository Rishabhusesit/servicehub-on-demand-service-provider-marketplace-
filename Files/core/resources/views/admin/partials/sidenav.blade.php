                ...
                @foreach($sideBarLinks as $key => $data)
                    ...
                    @if(isset($data->submenu))
                        <li class="sidebar-menu-item sidebar-dropdown">
                            <a href="javascript:void(0)" @if(isset($data->menu_active)) class="{{ menuActive($data->menu_active, 3) }}" @endif>
                            ...
                            <div class="sidebar-submenu {{ isset($data->menu_active) ? menuActive($data->menu_active, 2) : '' }} ">
                                <ul>
                                    ...
                                    @endphp
                                        <li class="sidebar-menu-item {{ isset($menu->menu_active) ?  menuActive($menu->menu_active) : '' }} ">
                    ...
                    @else
                        ...
                        @endphp
                        <li class="sidebar-menu-item {{ isset($data->menu_active) ? menuActive($data->menu_active) : '' }}">
