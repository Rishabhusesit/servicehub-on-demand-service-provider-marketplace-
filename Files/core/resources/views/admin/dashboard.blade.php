...
@section('panel')
    ...
    <div class="row mt-2 gy-4">
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="2" link="{{ route('admin.providers.all') }}" icon="las la-user-friends" title="Total Providers"
                      value="{{ $widget['total_providers'] }}" color="primary" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="2" link="{{ route('admin.providers.active') }}" icon="las la-user-check"
                      title="Active Providers" value="{{ $widget['verified_providers'] }}" color="success" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="2" link="{{ route('admin.providers.email.unverified') }}" icon="lar la-envelope"
                      title="Email Unverified Providers" value="{{ $widget['email_unverified_providers'] }}" color="danger" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="2" link="{{ route('admin.providers.mobile.unverified') }}" icon="las la-comment-slash"
                      title="Mobile Unverified Providers" value="{{ $widget['mobile_unverified_providers'] }}" color="warning" />
        </div><!-- dashboard-w1 end -->
    </div><!-- row end-->
    ...
    <div class="row gy-4 mt-2">
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="3" link="{{ route('admin.promotion.coupon.index') }}" icon="las la-bullhorn"
                      title="Active Coupon" value="{{ $widget['active_coupon'] }}" bg="primary" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="3" link="{{ route('admin.category.index') }}" icon="las la-list" title="Category"
                      value="{{ $widget['category'] }}" bg="1" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="3" link="{{ route('admin.zone.city') }}" icon="las la-location-arrow" title="City"
                      value="{{ $widget['city'] }}" bg="14" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="3" link="{{ route('admin.zone.area') }}" icon="las la-map-marked" title="Area"
                      value="{{ $widget['area'] }}" bg="19" />
        </div><!-- dashboard-w1 end -->
    </div><!-- row end-->
    ...
    <div class="row gy-4 mt-2">
        <div class="col-xxl-2 col-lg-4 col-sm-6">
            <x-widget style="5" link="{{ route('admin.orders.all') }}" icon="las la-shopping-cart "
                      title="All Orders" value="{{ $orders['all'] }}" bg="primary" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-2 col-lg-4 col-sm-6">
            <x-widget style="5" link="{{ route('admin.orders.pending') }}" icon="las la-luggage-cart"
                      title="Pending Orders" value="{{ $orders['pending'] }}" bg="1" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-2 col-lg-4 col-sm-6">
            <x-widget style="5" link="{{ route('admin.orders.processing') }}" icon="las la-spinner"
                      title="Processing Orders" value="{{ $orders['processing'] }}" bg="2" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-2 col-lg-4 col-sm-6">
            <x-widget style="5" link="{{ route('admin.orders.requested') }}" icon="las la-truck-loading"
                      title="Requested Orders" value="{{ $orders['requested'] }}" bg="3" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-2 col-lg-4 col-sm-6">
            <x-widget style="5" link="{{ route('admin.orders.completed') }}" icon="las la-check-double"
                      title="Completed Orders" value="{{ $orders['completed'] }}" bg="4" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-2 col-lg-4 col-sm-6">
            <x-widget style="5" link="{{ route('admin.orders.cancelled') }}" icon="las la-times-circle"
                      title="Cancelled Orders" value="{{ $orders['cancelled'] }}" bg="5" />
        </div><!-- dashboard-w1 end -->
    </div><!-- row end-->
