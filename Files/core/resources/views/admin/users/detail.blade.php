        ...
        <div class="col-12">
            <div class="row gy-4">
                ...
                <div class="col-xxl-3 col-sm-6">
                    <x-widget
                              style="7"
                              link="{{ route('admin.orders.all') }}?search={{ $user->username }}"
                              title="Completed Order Amount"
                              icon="las la-money-bill-wave-alt"
                              value="{{ showAmount($completeOrderAmount) }}"
                              bg="indigo"
                              type="2" />
                </div>
                ...
                <div class="col-xxl-3 col-sm-6">
                    <x-widget
                              ...
                              value="{{ getAmount($completedOrder) }}"
                              bg="success"
                              type="2" />
                </div>
