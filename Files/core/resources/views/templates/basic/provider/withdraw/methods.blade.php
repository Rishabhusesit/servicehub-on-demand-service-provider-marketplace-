...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <form action="{{ route('provider.withdraw.money') }}" method="post" class="withdraw-form">
                    @csrf
                    <h5 class="profile-header__title pb-4"> @lang('Withdraw')</h5>
                                        ...
                                        <label for="{{ titleToKey($data->name) }}"
                                            ...
                                            <span class="payment-check d-none">
                                                <input class="payment-item__radio gateway-input"
                                                    id="{{ titleToKey($data->name) }}" type="radio" name="method_code"
                                                    value="{{ $data->id }}" data-gateway='@php echo json_encode($data) @endphp'
