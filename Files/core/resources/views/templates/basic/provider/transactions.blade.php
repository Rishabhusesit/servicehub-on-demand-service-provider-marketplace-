        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="show-filter mb-3 text-end">
                    <button type="button" class="btn btn--base showFilterBtn btn-sm"><i class="las la-filter"></i></button>
                </div>
                        ...
                        <form>
                            <div class="d-flex flex-wrap gap-4">
                                ...
                                <div class="flex-grow-1 align-self-end">
                                    <button class="btn btn-primary btn--base w-100"><i class="las la-filter"></i>
                                        @lang('Filter')</button>
                                </div>
                            </div>
                        </form>
                ...
                <table class="table table--border table--collapse table--responsive--xl">
                    <thead>
                        <tr>
                            <th>@lang('Trx')</th>
